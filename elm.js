		...
		var isWithin = F2(
			function (_p1, _p0) {
				...
				return (_elm_lang$core$Native_Utils.cmp(
					...
					proximity) < 0) && (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$Basics$abs(_p2._1 - _p3._1),
					proximity) < 0);
			});
		var locationIsWithinRange = A2(
			isWithin,
			location.coords,
			{ctor: '_Tuple2', _0: geoloc.latitude, _1: geoloc.longitude});
		return {
			ctor: '_Tuple2',
			_0: A3(
				_elm_community$list_extra$List_Extra$replaceIf,
				function (l) {
					return _elm_lang$core$Native_Utils.eq(l.name, location.name);
				},
				_elm_lang$core$Native_Utils.update(
					location,
					{found: locationIsWithinRange}),
				locations),
			_1: locationIsWithinRange
		};
	});
var _user$project$Main$matchGeoError = function (error) {
	...
	switch (_p4.ctor) {
		case 'PermissionDenied':
			return A2(_elm_lang$core$Basics_ops['++'], 'Permission Denied: ', _p4._0);
		case 'LocationUnavailable':
			return A2(_elm_lang$core$Basics_ops['++'], 'Location Unavailable: ', _p4._0);
		default:
			return A2(_elm_lang$core$Basics_ops['++'], 'Timeout: ', _p4._0);
	}
};
...
var _user$project$Main$CheckLocation = F2(
	function (a, b) {
	...
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'LocationClicked':
				var _p6 = _p5._0;
				return _p6.found ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(
