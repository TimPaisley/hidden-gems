...
var _user$project$Main$gemIcon = F2(
	function (size, color) {
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$width(size),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$height(size),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 26 26'),
								_1: {ctor: '[]'}
							}
						}
					},
					{
						...
						_0: A2(
							_elm_lang$svg$Svg$polygon,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$points('6.5 3 19.5 3 26 9.66666667 13 23 0 9.66666667'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
...
var _user$project$Main$header = function (gems) {
	return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Hidden Gems'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Main$gemIcon, 20, '#FFF'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(gems)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Main$matchGeoError = function (error) {
	var _p0 = error;
	switch (_p0.ctor) {
		case 'PermissionDenied':
			return A2(_elm_lang$core$Basics_ops['++'], 'Permission Denied: ', _p0._0);
		case 'LocationUnavailable':
			return A2(_elm_lang$core$Basics_ops['++'], 'Location Unavailable: ', _p0._0);
		default:
			return A2(_elm_lang$core$Basics_ops['++'], 'Timeout: ', _p0._0);
	}
};
...
var _user$project$Main$Location = F5(
	function (a, b, c, d, e) {
		return {coords: a, name: b, img: c, cost: d, found: e};
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$CheckLocation = function (a) {
	return {ctor: 'CheckLocation', _0: a};
};
	...
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'LocationClicked':
				return _p1._0.found ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_elm_lang$core$Task$attempt, _user$project$Main$CheckLocation, _elm_lang$geolocation$Geolocation$now)
				};
			case 'CheckLocation':
				var _p2 = _p1._0;
				if (_p2.ctor === 'Err') {
					return function (error) {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									error: _user$project$Main$matchGeoError(error)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}(
						A2(_elm_lang$core$Debug$log, 'Error Occurred: ', _p2._0));
				} else {
					return function (_p3) {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}(
						A2(_elm_lang$core$Debug$log, 'Location Received: ', _p2._0));
				}
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
		...
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$LocationClicked(location)),
				_1: {ctor: '[]'}
			}
		},
		{
				...
				_elm_lang$html$Html$img,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$src(
							A2(_elm_lang$core$Basics_ops['++'], 'images/', location.img)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('gems'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(_user$project$Main$gemIcon, 13, '#000'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(location.cost)),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
...
var _user$project$Main$locations = function (locations) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('locations'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				A2(_elm_lang$core$List$map, _user$project$Main$locationCard, locations)),
			_1: {ctor: '[]'}
		});
};
